# Kite Autocomplete Plugin for Vim/Neovim

Kite is an AI-powered programming assistant that helps you write Python & JavaScript code inside Vim. Kite helps you write code faster by saving you keystrokes and showing you the right information at the right time. Learn more about how Kite helps you while you're using Vim at https://kite.com/integrations/vim/.
...
Some completions are actually autogenerated code snippets which can be filled in (only available for Python).  These will be highlighted with the Underline highlight group.
...
Kite can show how other people used the signature you are using (only available for Python).  By default this is off to save space.
...
As you edit your code, the [Kite Copilot](https://kite.com/copilot/) will automatically show examples and docs for Python code under your cursor.
